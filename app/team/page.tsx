  ...
  const teamMembers = [
    {
      ...
      image: "/andre.jpeg",
      description: "Researching in machine learning on code. Creator of RepairBench. Interned at Microsoft.",
      socials: [
    ...
    },
    {
      ...
      image: "/nuno.png",
      description: "Researcher in software reliability, data mining, and IaC. Published at all top 3 SWE conferences.",
      socials: [
    ...
    },
    {
      ...
      image: "/joao.jpg",
      description: "Computer Science Professor. Focused on automated reasoning and software reliability.",
      socials: [

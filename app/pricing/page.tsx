        ...
        <div className="max-w-5xl mx-auto px-4 py-24 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-between">
              ...
              <Link href="/contact" className="block w-full py-3 text-sm font-medium bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Get In Touch</Link>
            </div>
            <div className="bg-white p-8 rounded-xl border-2 bg-gray-200 shadow-lg relative flex flex-col justify-between">
              ...
              <Link href="/contact" className="block w-full py-3 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-lg transition-colors">Get In Touch</Link>
            </div>
          </div>
        </div>
      </main>
